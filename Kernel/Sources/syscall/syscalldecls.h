...
typedef intptr_t (*syscall_func_t)(VirtualProcessor* _Nonnull vp, void* _Nonnull args);
...
extern intptr_t _SYSCALL_##__name(VirtualProcessor* _Nonnull vp, void* _Nonnull args)
...
intptr_t _SYSCALL_##__name(VirtualProcessor* _Nonnull vp, const struct args##__name* _Nonnull pa)
...
intptr_t _SYSCALL_##__name(VirtualProcessor* _Nonnull vp, const struct args_##__name* _Nonnull pa)

...
;
    ...
    xdef __atomic_int_fetch_xor_reg
    xdef __atomic_int_fetch_and_reg
...
__atomic_int_compare_exchange_strong_reg:
        DISABLE_INTERRUPTS_SP
        move.l  (a0), d0
        cmp.l   (a1), d0
        bne.s   .not_same

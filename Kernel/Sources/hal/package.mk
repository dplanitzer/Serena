...
HAL_C_INCLUDES := $(KERNEL_C_INCLUDES) -I$(HAL_SOURCES_DIR)
HAL_ASM_INCLUDES := $(KERNEL_ASM_INCLUDES) -I$(HAL_SOURCES_DIR)
...
$(HAL_OBJS_DIR)/%.o : $(HAL_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(KERNEL_CC_CONFIG) $(CC_KOPT_SETTING) $(CC_GEN_DEBUG_INFO) $(KERNEL_CC_PREPROC_DEFS) $(HAL_C_INCLUDES) $(KERNEL_CC_DONTWARN) $(HAL_GENERATE_DEPS) -o $@ $<

...
$(CONSOLE_BUILD_DIR)/%.o : $(CONSOLE_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(CC_OPT_SETTING) $(CC_GENERATE_DEBUG_INFO) $(CC_PREPROCESSOR_DEFINITIONS) $(CONSOLE_C_INCLUDES) $(CONSOLE_DONTWARN) $(CONSOLE_GENERATE_DEPS) -o $@ $<

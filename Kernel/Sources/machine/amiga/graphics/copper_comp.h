...
extern copper_instr_t* _Nonnull copper_comp_compile(copper_instr_t* _Nonnull ip, Screen* _Nonnull scr, Sprite* _Nullable mouseCursor, bool isLightPenEnabled, bool isOddField);

...
extern errno_t ZorroDriver_Create(Class* _Nonnull pClass, DriverOptions options, CatalogId parentDirId, const zorro_conf_t* _Nonnull config, DriverRef _Nullable * _Nonnull pOutSelf);

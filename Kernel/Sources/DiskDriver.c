...
size_t DiskDriver_getBlockCount(DiskDriverRef _Nonnull self)
{
    return 0;
}
...
errno_t DiskDriver_getBlock(DiskDriverRef _Nonnull self, void* _Nonnull pBuffer, size_t idx)
{
    return EIO;
}
...
errno_t DiskDriver_putBlock(DiskDriverRef _Nonnull self, const void* _Nonnull pBuffer, size_t idx)
{
    return EIO;
}

...
PROCESS_CC_DONTWARN := -dontwarn=51 -dontwarn=148 -dontwarn=208
...
$(PROCESS_OBJS_DIR)/%.o : $(PROCESS_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(KERNEL_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(KERNEL_CC_PREPROC_DEFS) $(PROCESS_C_INCLUDES) $(PROCESS_CC_DONTWARN) $(PROCESS_GENERATE_DEPS) -o $@ $<

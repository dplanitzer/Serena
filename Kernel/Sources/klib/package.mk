...
KLIB_C_INCLUDES := -I$(LIBABI_HEADERS_DIR) -I$(KERNEL_SOURCES_DIR) -I$(KLIB_SOURCES_DIR)
KLIB_ASM_INCLUDES := -I$(LIBABI_HEADERS_DIR) -I$(KERNEL_SOURCES_DIR) -I$(KLIB_SOURCES_DIR)

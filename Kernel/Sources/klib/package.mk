...
$(KLIB_OBJS_DIR)/%.o : $(KLIB_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(KERNEL_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(KERNEL_CC_PREPROC_DEFS) $(KLIB_C_INCLUDES) $(KERNEL_CC_DONTWARN) $(KLIB_GENERATE_DEPS) -o $@ $<

$(KLIB_OBJS_DIR)/%.o : $(KLIB_SOURCES_DIR)/%.s
	@echo $<
	@$(AS) $(KERNEL_ASM_CONFIG) $(KLIB_ASM_INCLUDES) $(KERNEL_AS_DONTWARN) -o $@ $<

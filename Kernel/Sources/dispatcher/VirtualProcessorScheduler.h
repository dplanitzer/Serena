...
extern void VirtualProcessorScheduler_CreateForLocalCPU(SystemDescription* _Nonnull pSysDesc, BootAllocator* _Nonnull pBootAlloc, VoidFunc_1 _Nonnull pFunc, void* _Nullable _Weak pContext);
...
// preemption disabled.
extern errno_t VirtualProcessorScheduler_WaitOn(VirtualProcessorScheduler* _Nonnull pScheduler, List* _Nonnull pWaitQueue, struct timespec deadline, bool isInterruptable);

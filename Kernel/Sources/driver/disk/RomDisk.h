...
extern errno_t RomDisk_Create(const char* _Nonnull name, const void* _Nonnull pImage, size_t blockSize, scnt_t blockCount, bool freeOnClose, RomDiskRef _Nullable * _Nonnull pOutSelf);

...
extern errno_t DiskDriver_Create(Class* _Nonnull pClass, unsigned options, CatalogId parentDirId, const drive_info_t* _Nonnull driveInfo, DriverRef _Nullable * _Nonnull pOutSelf);

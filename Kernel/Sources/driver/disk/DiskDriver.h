...
extern errno_t DiskDriver_Create(Class* _Nonnull pClass, DriverOptions options, CatalogId parentDirId, const drive_info_t* _Nonnull driveInfo, DriverRef _Nullable * _Nonnull pOutSelf);

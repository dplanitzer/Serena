...
static bool zorro_read_config_space(ZorroConfiguration* _Nonnull cfg, uint8_t busToScan)
{
...
static uint8_t* _Nullable zorro_calculate_base_address_for_board_in_range(const ZorroConfiguration* _Nonnull cfg, const ZorroBus* _Nonnull bus, uint8_t* board_space_base_addr, uint8_t* board_space_top_addr)
{
    ...
    const ZorroConfiguration* pHighestAllocatedBoard = NULL;
...
static uint8_t* _Nullable zorro_calculate_base_address_for_board(const ZorroConfiguration* _Nonnull cfg, const ZorroBus* _Nonnull bus)
{

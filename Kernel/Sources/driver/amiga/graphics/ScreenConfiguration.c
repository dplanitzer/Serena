...
size_t ScreenConfiguration_GetPixelWidth(const ScreenConfiguration* _Nonnull self)
{
    return self->width;
}

size_t ScreenConfiguration_GetPixelHeight(const ScreenConfiguration* _Nonnull self)
{
    return self->height;
}

size_t ScreenConfiguration_GetRefreshRate(const ScreenConfiguration* _Nonnull self)
{
    return self->fps;
}

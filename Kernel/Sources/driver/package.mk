...
DRIVER_AS_DONTWARN := -nowarn=62
DRIVER_CC_DONTWARN := -dontwarn=51 -dontwarn=148 -dontwarn=208
...
$(DRIVER_OBJS_DIR)/%.o : $(DRIVER_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(KERNEL_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(KERNEL_CC_PREPROC_DEFS) $(DRIVER_C_INCLUDES) $(DRIVER_CC_DONTWARN) $(DRIVER_GENERATE_DEPS) -o $@ $<

$(DRIVER_OBJS_DIR)/%.o : $(DRIVER_SOURCES_DIR)/%.s
	@echo $<
	@$(AS) $(KERNEL_ASM_CONFIG) $(DRIVER_ASM_INCLUDES) $(DRIVER_AS_DONTWARN) -o $@ $<

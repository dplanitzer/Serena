...
extern errno_t DfsDirectoryItem_Create(ino_t inid, FilePermissions permissions, uid_t uid, gid_t gid, ino_t pnid, DfsDirectoryItem* _Nullable * _Nonnull pOutSelf);
...
extern errno_t DfsDirectoryItem_GetNameOfEntryWithId(DfsDirectoryItem* _Nonnull self, ino_t inid, MutablePathComponent* _Nonnull mpc);
extern errno_t DfsDirectoryItem_AddEntry(DfsDirectoryItem* _Nonnull self, ino_t inid, const PathComponent* _Nonnull pc);
extern errno_t DfsDirectoryItem_RemoveEntry(DfsDirectoryItem* _Nonnull self, ino_t inid);

extern errno_t DfsDeviceItem_Create(ino_t inid, FilePermissions permissions, uid_t uid, gid_t gid, DriverRef _Nonnull pDriver, intptr_t arg, DfsDeviceItem* _Nullable * _Nonnull pOutSelf);

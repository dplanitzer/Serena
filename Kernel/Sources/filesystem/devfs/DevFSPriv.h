...
extern errno_t DevFS_InsertDirectoryEntry(DevFSRef _Nonnull _Locked self, DfsDirectoryRef _Nonnull _Locked dir, ino_t inid, const PathComponent* _Nonnull name);

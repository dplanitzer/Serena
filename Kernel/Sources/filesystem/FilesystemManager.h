...
extern errno_t FilesystemManager_Mount(FilesystemManagerRef _Nonnull pManager, FilesystemRef _Nonnull pFileSys, const void* _Nullable pParams, ssize_t paramsSize, InodeRef _Nullable _Locked pDirNode);

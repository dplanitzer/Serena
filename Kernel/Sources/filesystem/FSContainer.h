...
open_class_funcs(FSContainer, Object,
    ...
    errno_t (*mapBlock)(void* _Nonnull self, blkno_t lba, MapBlock mode, FSBlock* _Nonnull blk);
    ...
    errno_t (*prefetchBlock)(void* _Nonnull self, blkno_t lba);
    ...
    // clean.
    errno_t (*syncBlock)(void* _Nonnull self, blkno_t lba);

...
FILESYSTEM_SERENAFS_CC_DONTWARN := -dontwarn=51 -dontwarn=148 -dontwarn=208
...
$(FILESYSTEM_SERENAFS_OBJS_DIR)/%.o : $(FILESYSTEM_SERENAFS_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(KERNEL_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(KERNEL_CC_PREPROC_DEFS) $(FILESYSTEM_SERENAFS_C_INCLUDES) $(FILESYSTEM_SERENAFS_CC_DONTWARN) $(FILESYSTEM_SERENAFS_GENERATE_DEPS) -o $@ $<

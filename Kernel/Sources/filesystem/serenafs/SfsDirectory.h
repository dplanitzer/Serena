...
extern errno_t SfsDirectory_RemoveEntry(InodeRef _Nonnull _Locked self, ino_t idToRemove);
extern errno_t SfsDirectory_InsertEntry(InodeRef _Nonnull _Locked self, const PathComponent* _Nonnull pName, ino_t id, const sfs_insertion_hint_t* _Nullable ih);

...
extern errno_t _dispatch_worker_create(dispatch_t _Nonnull owner, dispatch_worker_t _Nullable * _Nonnull pOutSelf);
...
(dispatch_worker_t)vcpu_current()->udata
...
extern errno_t _dispatch_rearm_timer(dispatch_t _Nonnull _Locked self, dispatch_timer_t _Nonnull timer);

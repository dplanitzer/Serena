...
extern errno_t dispatch_item_async(dispatch_t _Nonnull self, int flags, dispatch_item_t _Nonnull item);

// Similar to dispatch_item_async(), except that this function blocks until the
// dispatched item has finished execution.
extern errno_t dispatch_item_sync(dispatch_t _Nonnull self, dispatch_item_t _Nonnull item);
...
extern errno_t dispatch_item_await(dispatch_t _Nonnull self, dispatch_item_t _Nonnull item);
...
// the same time.
extern errno_t dispatch_item_on_signal(dispatch_t _Nonnull self, int signo, dispatch_item_t _Nonnull item);

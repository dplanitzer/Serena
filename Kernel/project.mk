...
DRIVER_AMIGA_CBM_FLOPPY_SOURCES_DIR := $(KERNEL_SOURCES_DIR)/driver/amiga/cbm-floppy
DRIVER_AMIGA_CBM_FLOPPY_OBJS_DIR := $(KERNEL_OBJS_DIR)/driver/amiga/cbm-floppy

DRIVER_AMIGA_CBM_GRAPHICS_SOURCES_DIR := $(KERNEL_SOURCES_DIR)/driver/amiga/cbm-graphics
DRIVER_AMIGA_CBM_GRAPHICS_OBJS_DIR := $(KERNEL_OBJS_DIR)/driver/amiga/cbm-graphics
...
-include $(DRIVER_AMIGA_CBM_FLOPPY_SOURCES_DIR)/package.mk
-include $(DRIVER_AMIGA_CBM_GRAPHICS_SOURCES_DIR)/package.mk
...
$(KERNEL_FILE): $(KRT_OBJS) $(KOBJ_OBJS) $(KLIB_OBJS) $(CONSOLE_OBJS) $(DISPATCHER_OBJS) \
				$(DISPATCHQUEUE_OBJS) $(DRIVER_OBJS) $(DRIVER_AMIGA_OBJS) \
				$(DRIVER_AMIGA_CBM_FLOPPY_OBJS) \
				$(DRIVER_AMIGA_CBM_GRAPHICS_OBJS) $(DRIVER_HID_OBJS) $(FILESYSTEM_OBJS) \

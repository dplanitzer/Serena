...
$(KERNEL_FILE): $(KRT_OBJS) $(KLIB_OBJS) $(CONSOLE_OBJS) $(DISPATCHER_OBJS) $(DRIVER_OBJS) $(DRIVER_AMIGA_OBJS) $(DRIVER_HID_OBJS) $(FILESYSTEM_OBJS) $(FILESYSTEM_SERENAFS_OBJS) $(HAL_OBJS) $(PROCESS_OBJS) $(KERNEL_OBJS) | $(KERNEL_PRODUCT_DIR)
	@echo Linking Kernel

...
KERNEL_TESTS_C_INCLUDES := -I$(LIBDISPATCH_HEADERS_DIR) -I$(LIBC_HEADERS_DIR) -I$(LIBM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(KERNEL_TESTS_SOURCES_DIR)
...
$(KERNEL_TESTS_FILE): $(CSTART_FILE) $(KERNEL_TESTS_OBJS) $(LIBC_FILE) $(LIBM_FILE) $(LIBDISPATCH_FILE)

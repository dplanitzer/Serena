...
errno_t SfsDirectory_read(SfsDirectoryRef _Nonnull _Locked self, off_t* _Nonnull pOffset, void* _Nonnull buf, ssize_t nDstBytesToRead, ssize_t* _Nonnull pOutDstBytesRead)
{
    decl_try_err();

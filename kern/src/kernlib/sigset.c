...
const sigset_t SIGSET_NON_ROUTABLE = sig_bit(SIG_FORCE_QUIT) | sig_bit(SIG_FORCE_STOP) | sig_bit(SIG_CONTINUE) | sig_bit(SIG_SYSTEM);
const sigset_t SIGSET_URGENTS = sig_bit(SIG_FORCE_QUIT) | sig_bit(SIG_SYSTEM);

...
extern errno_t Process_GetVirtualProcessorIds(ProcessRef _Nonnull self, const vcpu_matcher_t* _Nullable matchers, vcpuid_t* _Nonnull buf, size_t bufSize, int* _Nonnull out_hasMore);

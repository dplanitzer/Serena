...
// configuration.
extern const video_conf_t* _Nullable get_matching_video_conf(int width, int height, vio_pixfmt_t fmt);
...
extern int8_t PixelFormat_GetPlaneCount(vio_pixfmt_t format);

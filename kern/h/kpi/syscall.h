...
enum {
    ...
    SC_ww_wait,             // errno_t ww_wait(volatile atomic_int* _Nonnull addr, int expected)
    SC_proc_vcpus,          // int proc_vcpus(const vcpu_matcher_t* _Nullable matchers, vcpuid_t* _Nonnull buf, size_t bufSize)
    SC_ww_timedwait,        // errno_t ww_timedwait(volatile atomic_int* _Nonnull addr, int expected, int flags, const nanotime_t* _Nonnull wtp)
    ...
    SC_sig_send,            // sig_send(int target, id_t id, int signo)
    ...
    SC_ww_wakeup,           // ww_wakeup(volatile atomic_int* _Nonnull addr, int flags)

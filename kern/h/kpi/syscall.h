...
enum {
    ...
    SC_clock_wait,          // errno_t clock_wait(clockid_t clock, int flags, const struct timespec* _Nonnull wtp, struct timespec* _Nullable rmtp)
    SC_vm_allocate,         // errno_t vm_allocate(size_t nbytes, void **pOutMem)
    SC_proc_exit,           // _Noreturn void proc_exit(int status)
    SC_proc_spawn,          // errno_t proc_spawn(const char* _Nonnull path, const char* _Nullable argv[], proc_spawn_t * _Nullable options, pid_t * _Nullable rpid)
    ...
    SC_proc_setumask,       // void proc_setumask(mode_t mask)
    SC_fs_create_directory, // errno_t fs_create_directory(int wd, const char* _Nonnull path, mode_t mode)
    ...
    SC_clock_time,          // errno_t clock_time(clockid_t clock, struct timespec* _Nonnull ts)
    ...
    SC_sig_timedwait,       // int sig_timedwait(const sigset_t* _Nonnull set, int flags, const struct timespec* _Nonnull wtp, int* _Nonnull signo)

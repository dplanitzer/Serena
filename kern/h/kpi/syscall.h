...
enum {
    ...
    SC_proc_spawn,          // errno_t proc_spawn(int wd, const char* _Nonnull path, const char* _Nullable argv[], proc_spawn_t * _Nullable options, pid_t * _Nullable rpid)
    ...
    SC_proc_exec,           // int proc_exec(int wd, const char* _Nonnull path, const char* _Nullable argv[], const char* _Nullable * _Nullable envp)

...
enum {
    ...
    SC_proc_spawn,          // errno_t proc_spawn(const char* _Nonnull path, const char* _Nullable argv[], , const char* _Nullable envp[], proc_spawn_t * _Nullable options, pid_t * _Nullable rpid)

...
enum {
    ...
    SC_fs_setowner,         // errno_t fs_setowner(dir_t* _Nullable wd, const char* _Nonnull path, uid_t uid, gid_t gid)
    SC_fcntl,               // int fcntl(int fd, int cmd, int* _Nonnull pResult, ...)
    SC_fs_setperms,         // errno_t fs_setperms(dir_t* _Nullable wd, const char* _Nonnull path, mode_t mode)

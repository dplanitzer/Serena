...
enum {
    ...
    SC_fs_open,             // errno_t fs_open(const char * _Nonnull name, int oflags, int* _Nonnull fd)
    ...
    SC_fs_create_file,      // errno_t fs_create_file(const char* _Nonnull path, int options, fs_perms_t fsperms, int* _Nonnull fd)

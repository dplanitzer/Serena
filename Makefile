...
DISKUTIL_FILE := $(CMDS_OBJS_DIR)/diskutil
...
$(BOOT_DMG_FILE): $(SNAKE_FILE) $(LOGIN_FILE) $(SH_FILE) $(SYSTEMD_FILE) $(FSID_FILE) $(INFO_FILE) $(DISKUTIL_FILE) $(TYPE_FILE) $(KERNEL_TESTS_FILE) | $(PRODUCT_DIR)
	...
	$(DISKIMAGE) push -m=rwxr-xr-x $(DISKUTIL_FILE) /System/Commands/ $(BOOT_DMG_FILE)

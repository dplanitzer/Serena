...
KERNEL_HEADERS_DIR := $(KERNEL_PROJECT_DIR)/Headers
...
KERNEL_CC_CONFIG := +$(VC_CONFIG) -c -c99 -cpp-comments -cpu=68020 -D_POSIX_SOURCE=1 -D_OPEN_SYS_ITOA_EXT=1 -D__TRY_BANG_BEHAVIOR=1 -DMACHINE_AMIGA $(KERNEL_STDC_PREPROC_DEFS)

...
$(BOOT_DMG_FILE): $(SNAKE_FILE) $(SH_FILE) $(SYSTEMD_FILE) $(DELETE_FILE) $(DISK_FILE) $(ID_FILE) $(LOGIN_FILE) $(MAKEDIR_FILE) $(RENAME_FILE) $(SHUTDOWN_FILE) $(TYPE_FILE) $(UPTIME_FILE) $(KERNEL_TESTS_FILE) | $(PRODUCT_DIR)

...
STRING_SC_SOURCES := $(STRING_SOURCES_DIR)/strcat.c \
...
$(STRING_SC_OBJS_DIR)/%.o : $(STRING_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(USER_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(CC_PREPROC_DEFS) $(STRING_C_INCLUDES) $(LIBC_CC_DONTWARN) $(STRING_SC_GENERATE_DEPS) -o $@ $<

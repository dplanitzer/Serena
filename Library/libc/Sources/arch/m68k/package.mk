...
ARCH_M68K_SC_SOURCES := $(ARCH_M68K_SOURCES_DIR)/abs.c \
						$(ARCH_M68K_SOURCES_DIR)/div.c \
						$(ARCH_M68K_SOURCES_DIR)/_divmods64.c

ARCH_M68K_SC_OBJS := $(patsubst $(ARCH_M68K_SOURCES_DIR)/%.c,$(ARCH_M68K_SC_OBJS_DIR)/%.o,$(ARCH_M68K_SC_SOURCES))
ARCH_M68K_SC_DEPS := $(ARCH_M68K_SC_OBJS:.o=.d)

#ARCH_M68K_SC_GENERATE_DEPS = -deps -depfile=$(patsubst $(ARCH_M68K_SC_OBJS_DIR)/%.o,$(ARCH_M68K_SC_OBJS_DIR)/%.d,$@)
ARCH_M68K_SC_GENERATE_DEPS := 
...
-include $(ARCH_M68K_SC_DEPS)

$(ARCH_M68K_SC_OBJS_DIR)/%.o : $(ARCH_M68K_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(KERNEL_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(CC_PREPROC_DEFS) $(ARCH_M68K_C_INCLUDES) $(LIBC_CC_DONTWARN) $(ARCH_M68K_SC_GENERATE_DEPS) -o $@ $<

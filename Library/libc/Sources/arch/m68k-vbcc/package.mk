...
ARCH_M68K_VBCC_C_SOURCES := $(wildcard $(ARCH_M68K_VBCC_SOURCES_DIR)/*.c)
ARCH_M68K_VBCC_ASM_SOURCES := $(wildcard $(ARCH_M68K_VBCC_SOURCES_DIR)/*.s)
...
ARCH_M68K_VBCC_OBJS += $(patsubst $(ARCH_M68K_VBCC_SOURCES_DIR)/%.s,$(ARCH_M68K_VBCC_OBJS_DIR)/%.o,$(ARCH_M68K_VBCC_ASM_SOURCES))
...
$(ARCH_M68K_VBCC_OBJS): | $(ARCH_M68K_VBCC_OBJS_DIR)
...
$(ARCH_M68K_VBCC_OBJS_DIR)/%.o : $(ARCH_M68K_VBCC_SOURCES_DIR)/%.s
	@echo $<
...
ARCH_M68K_VBCC_SC_SOURCES := $(wildcard $(ARCH_M68K_VBCC_SOURCES_DIR)/*.c)
ARCH_M68K_VBCC_SC_ASM_SOURCES := $(wildcard $(ARCH_M68K_VBCC_SOURCES_DIR)/*.s)

...
enum {
    ...
    SC_disp_schedule,       // errno_t disp_schedule(int od, os_dispatch_func_t _Nonnull func, void* _Nullable ctx, uint32_t options, uintptr_t tag)
    ...
    SC_disp_timer,          // errno_t disp_timer(int od, struct timespec deadline, struct timespec interval, os_dispatch_func_t _Nonnull func, void* _Nullable ctx, uintptr_t tag)
    ...
    SC_sigwait,             // int sigwait(const sigset_t* _Nullable mask, const sigset_t* _Nonnull set, siginfo_t* _Nullable info)
    SC_sigtimedwait,        // int sigtimedwait(const sigset_t* _Nullable mask, const sigset_t* _Nonnull set, int flags, const struct timespec* _Nonnull wtp, siginfo_t* _Nullable info)
    ...
    SC_acquire_vcpu,        // int proc_acquire_vcpu(const vcpu_acquire_params_t* _Nonnull params, vcpuid_t* _Nonnull idp)

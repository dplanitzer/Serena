...
enum {
    ...
    SC_sig_wait,            // int sig_wait(sigset_t* _Nullable sigs)
    SC_sig_timedwait,       // int sig_timedwait(int flags, const struct timespec* _Nonnull wtp, sigset_t* _Nullable sigs)

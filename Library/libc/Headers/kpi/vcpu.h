...
// VCPU_QOS_BACKGROUND: no guarantee with regards to schedule latency.
// VCPU_QOS_IDLE: kernel internal. Has only 1 priority. Only scheduled if there is nothing to schedule for a VCPU_QOS_XXX > VCPU_QOS_IDLE

...
# libc (hosted)
$(LIBC_FILE): $(ARCH_M68K_OBJS) $(EXT_OBJS) $(LOCALE_OBJS) $(MALLOC_OBJS) \
			  $(STDIO_OBJS) $(STDLIB_OBJS) $(STRING_OBJS) $(SYS_OBJS) \
			  $(TIME_OBJS)
	@echo Making libc.a
	$(LIBTOOL) create $@ $^
...
#libsc (freestanding)
$(LIBSC_FILE): $(ARCH_M68K_VBCC_SC_OBJS) $(EXT_SC_OBJS) $(STRING_SC_OBJS)
	@echo Making libsc.a
	$(LIBTOOL) create $@ $^

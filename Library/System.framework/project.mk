...
$(SYSTEM_BUILD_DIR)/%.o : $(SYSTEM_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(CC_OPT_SETTING) $(CC_GENERATE_DEBUG_INFO) $(CC_PREPROCESSOR_DEFINITIONS) -I$(SYSTEM_HEADERS_DIR) -I$(SYSTEM_SOURCES_DIR) -deps -depfile=$(patsubst $(SYSTEM_BUILD_DIR)/%.o,$(SYSTEM_BUILD_DIR)/%.d,$@) -o $@ $<

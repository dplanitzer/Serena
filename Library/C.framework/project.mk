...
$(CLIB_BUILD_DIR)/%.o : $(CLIB_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(CC_OPT_SETTING) $(CC_GENERATE_DEBUG_INFO) $(CC_PREPROCESSOR_DEFINITIONS) -I$(CLIB_HEADERS_DIR) -I$(CLIB_SOURCES_DIR) -I$(SYSTEM_HEADERS_DIR) -deps -depfile=$(patsubst $(CLIB_BUILD_DIR)/%.o,$(CLIB_BUILD_DIR)/%.d,$@) -o $@ $<

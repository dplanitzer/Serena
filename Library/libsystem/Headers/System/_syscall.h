...
#define SC_getcwd               14  // errno_t Process_GetCurrentWorkingDirectoryPath(char* buffer, size_t bufferSize)
#define SC_setcwd               15  // errno_t Process_SetCurrentWorkingDirectoryPath(const char* _Nonnull path)

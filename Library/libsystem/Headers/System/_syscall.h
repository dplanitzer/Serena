...
enum {
    ...
    SC_chdir,               // int chdir(const char* _Nonnull path)
    ...
    SC_setinfo,             // errno_t setinfo(const char* _Nonnull path, fmutinfo_t* _Nonnull info)
    SC_access,              // int access(const char* _Nonnull path, int mode)
    SC_fgetinfo,            // errno_t fgetinfo(int fd, finfo_t* _Nonnull info)
    SC_fsetinfo,            // errno_t fsetinfo(int fd, fmutinfo_t* _Nonnull info)
    SC_unlink,              // errno_t unlink(const char* path)
    SC_rename,              // int rename(const char* _Nonnull oldpath, const char* _Nonnull newpath)
    ...
    SC_disp_timer,          // errno_t disp_timer(int od, TimeInterval deadline, TimeInterval interval, dispatch_func_t _Nonnull func, void* _Nullable ctx, uintptr_t tag)

...
// Initializes a mutex.
extern errno_t os_mutex_init(mutex_t* _Nonnull mutex);
...
extern errno_t os_mutex_deinit(mutex_t* _Nonnull mutex);
...
// @Concurrency: Safe
extern errno_t os_mutex_trylock(mutex_t* _Nonnull mutex);
...
// @Concurrency: Safe
extern errno_t os_mutex_lock(mutex_t* _Nonnull mutex);

// Unlocks the mutex. Returns EPERM if the caller does not hold the mutex.
// Returns EOK on success.
// @Concurrency: Safe
extern errno_t os_mutex_unlock(mutex_t* _Nonnull mutex);

...
// an event arrives if none is pending. ETIMEDOUT is returned if no event is
// pending and the timeout has been exceeded.
// get_next_event(TimeInterval timeout, HIDEvent* _Nonnull evt)
#define kHIDCommand_GetNextEvent IOResourceCommand(0)
...
#define kHIDCommand_GetKeyRepeatDelays IOResourceCommand(1)
...
#define kHIDCommand_SetKeyRepeatDelays IOResourceCommand(2)
...
#define kHIDCommand_SetMouseCursor IOResourceCommand(3)
...
#define kHIDCommand_SetMouseCursorVisibility    IOResourceCommand(4)

// Returns the current mouse cursor visibility status.
// MouseCursorVisibility get_mouse_cursor_visibility(void)
#define kHIDCommand_GetMouseCursorVisibility    IOResourceCommand(5)
...
#define kHIDCommand_ShieldMouseCursor    IOResourceCommand(6)
...
#define kHIDCommand_UnshieldMouseCursor  IOResourceCommand(7)

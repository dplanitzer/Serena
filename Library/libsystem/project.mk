...
$(LIBSYSTEM_OBJS_DIR)/%.o : $(LIBSYSTEM_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(USER_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(CC_PREPROC_DEFS) -I$(LIBC_HEADERS_DIR) $(LIBSYSTEM_C_INCLUDES) $(LIBSYSTEM_CC_DONTWARN) $(LIBSYSTEM_GENERATE_DEPS) -o $@ $<

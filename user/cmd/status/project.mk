...
STATUS_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(LIBFLOWTERM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(STATUS_SOURCES_DIR)
...
$(STATUS_FILE): $(CSTART_FILE) $(STATUS_OBJS) $(LIBC_FILE) $(LIBCLAP_FILE) $(LIBFLOWTERM_FILE)
	@echo Linking status

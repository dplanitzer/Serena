...
CMDS_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(CMDS_SOURCES_DIR) -I$(KERNEL_SOURCES_DIR)

KERNEL_SOURCES_DIR := $(KERNEL_PROJECT_DIR)/src
SERENAFS_TOOLS_DIR = $(KERNEL_SOURCES_DIR)/filesystem/serenafs/tools
SERENAFS_TOOLS_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(CMDS_SOURCES_DIR) -I$(KERNEL_SOURCES_DIR)
...
.PHONY: clean-cmds $(CMD_OBJS_DIR) $(SERENAFS_TOOLS_OBJS_DIR)


build-cmds: $(COPY_FILE) $(DELETE_FILE) $(DISK_FILE) $(ID_FILE) $(LIST_FILE) \
...
$(DISK_FILE): $(CSTART_FILE) $(SERENAFS_TOOLS_OBJS_DIR)/format.o $(CMD_OBJS_DIR)/disk.o $(LIBC_FILE) $(LIBCLAP_FILE)
	@$(LD) $(USER_LD_CONFIG) -s -o $@ $^

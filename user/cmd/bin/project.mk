...
CMDS_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(LIBFLOWTERM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(CMDS_SOURCES_DIR)
...
build-cmds: $(COPY_FILE) $(CPU_FILE) $(DELETE_FILE) \
...
$(LOGIN_FILE): $(CSTART_FILE) $(CMD_OBJS_DIR)/login.o $(LIBC_FILE) $(LIBFLOWTERM_FILE)
	@$(LD) $(USER_LD_CONFIG) -s -o $@ $^

...
DISKTOOL_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(LIBFLOWTERM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(DISKTOOL_SOURCES_DIR)
...
$(DISKTOOL_OBJS): | $(DISKTOOL_OBJS_DIR) $(PRODUCT_CMD_DIR)

$(DISKTOOL_OBJS_DIR):
	$(call mkdir_if_needed,$(DISKTOOL_OBJS_DIR))


$(DISKTOOL_FILE): $(CSTART_FILE) $(DISKTOOL_OBJS) $(LIBC_FILE) $(LIBFLOWTERM_FILE) $(LIBCLAP_FILE)

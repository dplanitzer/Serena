...
BUILTINS_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(LIBFLOWTERM_HEADERS_DIR) -I$(LIBREADLINE_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(BUILTINS_SOURCES_DIR) -I$(SH_SOURCES_DIR)

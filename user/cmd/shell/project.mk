...
SH_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(LIBFLOWTERM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(SH_SOURCES_DIR)
...
$(SH_FILE): $(CSTART_FILE) $(SH_OBJS) $(BUILTINS_OBJS) $(LIBC_FILE) $(LIBFLOWTERM_FILE) $(LIBCLAP_FILE)
	@echo Linking sh

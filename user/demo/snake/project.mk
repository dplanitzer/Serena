...
SNAKE_C_INCLUDES := -I$(LIBDISPATCH_HEADERS_DIR) -I$(LIBFLOWTERM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBC_HEADERS_DIR) -I$(SNAKE_SOURCES_DIR)
...
$(SNAKE_FILE): $(CSTART_FILE) $(SNAKE_OBJS) $(LIBC_FILE) $(LIBDISPATCH_FILE) $(LIBFLOWTERM_FILE)
	@echo Linking snake

...
EXT_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(LIBM_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBC_SOURCES_DIR) -I$(EXT_SOURCES_DIR)
...
$(EXT_OBJS_DIR)/%.o : $(EXT_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(USER_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(CC_PREPROC_DEFS) -D__IEEE_BIG_ENDIAN=1 -D_NO_LONGDBL=1 $(EXT_C_INCLUDES) $(LIBC_CC_DONTWARN) $(EXT_GENERATE_DEPS) -o $@ $<

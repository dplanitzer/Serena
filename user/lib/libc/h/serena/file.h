...
// this case.
// @Concurrency: Safe
extern int fs_open(dir_t _Nullable wd, const char* _Nonnull path, fd_flags_t oflags);
...
// created.
// @Concurrency: Safe
extern int fs_create_file(dir_t _Nullable wd, const char* _Nonnull path, fd_flags_t oflags, fs_perms_t fsperms);

...
extern void _divmodu64(const iu64_t _Nonnull dividend_divisor[2], iu64_t* _Nonnull _Restrict quotient, iu64_t* _Nullable _Restrict remainder);
extern void _divmods64(const iu64_t _Nonnull dividend_divisor[2], iu64_t* _Nonnull _Restrict quotient, iu64_t* _Nullable _Restrict remainder);
...
extern long long _mulsint64_020(long long x, long long y);
extern long long _mulsint64_060(long long x, long long y);

extern unsigned long long _muluint64_020(unsigned long long x, unsigned long long y);
...
extern unsigned long long _flt64touint64(double x);
extern long long _flt64tosint64(double x);

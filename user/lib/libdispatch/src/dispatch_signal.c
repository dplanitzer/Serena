...
static sigset_t _SIGSET_NOSENDMON = sig_bit(_SIG_DISPATCH) | sig_bit(SIG_TERMINATE) | sig_bit(SIG_VCPU_RELINQUISH) | sig_bit(SIG_VCPU_SUSPEND) | sig_bit(SIG_FORCE_STOP);

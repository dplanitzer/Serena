...
$(COMPLEX_OBJS_DIR)/%.o : $(COMPLEX_SOURCES_DIR)/%.c
	@echo $<
	@$(CC) $(USER_CC_CONFIG) $(CC_OPT_SETTING) $(CC_GEN_DEBUG_INFO) $(CC_PREPROC_DEFS) $(LIBM_C_INCLUDES) -I$(COMPLEX_SOURCES_DIR) -I$(KERNEL_HEADERS_DIR) $(LIBM_CC_DONTWARN) $(COMPLEX_GENERATE_DEPS) -o $@ $<

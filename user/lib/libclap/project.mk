...
LIBCLAP_SOURCES_DIR := $(LIBCLAP_PROJECT_DIR)/src
...
LIBCLAP_C_INCLUDES := -I$(LIBC_HEADERS_DIR) -I$(KERNEL_HEADERS_DIR) -I$(LIBCLAP_HEADERS_DIR) -I$(LIBCLAP_SOURCES_DIR)
...
$(LIBCLAP_OBJS): | $(LIBCLAP_OBJS_DIR) $(PRODUCT_LIB_DIR)

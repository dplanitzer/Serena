...
$(COPY_FILE): $(CSTART_FILE) $(CMDS_OBJS_DIR)/copy.o $(LIBSYSTEM_FILE) $(LIBC_FILE) $(LIBCLAP_FILE)
...
$(LIST_FILE): $(CSTART_FILE) $(CMDS_OBJS_DIR)/list.o $(LIBSYSTEM_FILE) $(LIBC_FILE) $(LIBCLAP_FILE)
	@$(LD) $(USER_LD_CONFIG) -s -o $@ $^
...
$(STATUS_FILE): $(CSTART_FILE) $(CMDS_OBJS_DIR)/status.o $(LIBSYSTEM_FILE) $(LIBC_FILE) $(LIBCLAP_FILE)
	@$(LD) $(USER_LD_CONFIG) -s -o $@ $^
...
$(UPTIME_FILE): $(CSTART_FILE) $(CMDS_OBJS_DIR)/uptime.o $(LIBSYSTEM_FILE) $(LIBC_FILE) $(LIBCLAP_FILE)
	@$(LD) $(USER_LD_CONFIG) -s -o $@ $^


$(WAIT_FILE): $(CSTART_FILE) $(CMDS_OBJS_DIR)/wait.o $(LIBSYSTEM_FILE) $(LIBC_FILE) $(LIBCLAP_FILE)
	@$(LD) $(USER_LD_CONFIG) -s -o $@ $^

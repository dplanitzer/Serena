...
extern errno_t cmd_format(bool bQuick, FilePermissions rootDirPerms, User owner, const char* _Nonnull fsType, const char* _Nonnull dmgPath);
extern errno_t cmd_list(const char* _Nonnull path, const char* _Nonnull dmgPath);
extern errno_t cmd_makedir(bool shouldCreateParents, FilePermissions dirPerms, User owner, const char* _Nonnull path, const char* _Nonnull dmgPath);
extern errno_t cmd_pull(const char* _Nonnull path, const char* _Nonnull dstPath, const char* _Nonnull dmgPath);
extern errno_t cmd_push(FilePermissions filePerms, User owner, const char* _Nonnull srcPath, const char* _Nonnull path, const char* _Nonnull dmgPath);
